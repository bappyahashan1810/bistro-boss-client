...
const Featured = () => {
    return (
        <div className='mt-[130px] featured-item bg-fixed text-white  '>
            <SectionTitle
                heading={'FROM OUR MENU'}
                subheading={'---Check it out---'}
            ></SectionTitle>
            <div className='bg-opacity-60 bg-slate-400 mt-[48px] flex md:justify-center justify-between items-center md:ml-40'>
                ...
                <div className='ml-2'>
                    ...
                    <button className='uppercase btn border-b-2 p-2 border-0 font-bold'>Read More</button>
                </div>
            </div>
        </div>
    );
